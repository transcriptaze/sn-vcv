...
FS = [11025, 12000, 22050, 24000, 44100, 48000, 88200, 96000, 176400, 192000, 352800, 384000, 705600, 786800]
F0 = 16000  # cutoff frequency (Hz)
N = 4  # order of filter

print('const std::map<int, IIR> COEFFICIENTS = {')
...
for fs in FS:
    ...
    print('        %(fs)d,' % v)
    print('        IIR{')
    print('            .a = {%(a1).6f, %(a2).6f, %(a3).6f},' % v)
    print('            .b = {%(b0).6f, %(b1).6f, %(b2).6f, %(b3).6f}' % v)
    print('        },')
    print('    },')
