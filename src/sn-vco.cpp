...
void sn_vco::x1f1(float fs, float dt, int channels) {
    double phase[16];
    double in[16];
    double out[16];
...
void sn_vco::x2f2(float fs, float dt, int channels) {
    double in[16];
    double intermediate[16];
    double out[16];
...
void sn_vco::x4f2(float fs, float dt, int channels) {
    double in[16];
    double intermediate[16];
    double out[16];
